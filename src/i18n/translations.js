  ...
  sv: {
    ...
    pages: {
      ...
      buyCourse: {
        ...
        formIntro: 'Fyll i dina uppgifter så kontaktar vi dig med betalningsinformation.',
        nameLabel: 'Fullständigt namn',
        namePlaceholder: 'Ditt namn',
        emailLabel: 'E-post',
        emailPlaceholder: 'din.email@exempel.se',
  ...
  en: {
    ...
    pages: {
      ...
      buyCourse: {
        ...
        formIntro: 'Fill in your details and we\'ll contact you with payment information.',
        nameLabel: 'Full name',
        namePlaceholder: 'Your name',
        emailLabel: 'Email',
        emailPlaceholder: 'your.email@example.com',
