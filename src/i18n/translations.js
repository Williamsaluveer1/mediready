export const translations = {
  sv: {
    ...
    hero: {
      ...
      secondaryCta: 'Möt våra experter',
      trust: [
        { strong: 'Interaktiva kurser', span: 'Live föreläsningar' },
        { strong: '4 experter', span: 'ST & överläkare' },
    ...
    about: {
      ...
      values: [
        ...
        },
        {
          title: 'Språkträning',
          description:
            'Öva upp dina medicinska språkfärdigheter på svenska genom interaktiva sessioner med våra experter.',
        },
      ],
    },
    team: {
